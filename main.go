...
/*
  __           __                ___                                  __
 /\ \         /\ \              /\_ \                                /\ \
 \_\ \    ____\ \ \/'\      __  \//\ \    __  __  ____      __   _ __\ \ \
 /'_` \  /',__\\ \ , <    /'__`\  \ \ \  /\ \/\ \/\_ ,`\  /'__`\/\`'__\ \ \
/\ \L\ \/\__, `\\ \ \\`\ /\ \L\.\_ \_\ \_\ \ \_\ \/_/  /_/\  __/\ \ \/ \ \_\
\ \___,_\/\____/ \ \_\ \_\ \__/.\_\/\____\\/`____ \/\____\ \____\\ \_\  \/\_\
 \/__,_ /\/___/   \/_/\/_/\/__/\/_/\/____/ `/___/> \/____/\/____/ \/_/   \/_/
                                              /\___/
											  \/__/

DSKalyzer is an open source offshoot of the file handling code from the Octalyzer
project.
...
func binpath() string {
	...
	if runtime.GOOS == "windows" {
		return os.Getenv("USERPROFILE") + "/DSKalyzer"
	}
	return os.Getenv("HOME") + "/DSKalyzer"
